...
@macro
def select(input: AnyDensity, fallback: AnyDensity, selections: list[tuple[float | tuple[float, float], AnyDensity]]):
...
@macro
def shift(input: AnyDensity, shift_x: AnyDensity = 0, shift_y: AnyDensity = 0, shift_z: AnyDensity = 0):

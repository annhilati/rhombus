from rhombus.language import Density, densityfunction, builtinmacro
from rhombus.support.moredfs import types

__all__ = []

@builtinmacro
def acos(argument: densityfunction) -> Density[types.acos]:
...
@builtinmacro
def asin(argument: densityfunction) -> Density[types.asin]:
...
@builtinmacro
def atan(argument: densityfunction) -> Density[types.atan]:

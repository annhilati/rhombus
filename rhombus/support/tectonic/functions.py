from rhombus.std import Noise, Density, AnyDensity, builtinmacro
...
@builtinmacro
def config_noise(noise: Noise, key: str, shift_x: AnyDensity, shift_z: AnyDensity) -> Density[types.config_noise]:
    ""

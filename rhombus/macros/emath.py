...
@macro
def sqrt(argument: AnyDensity, iterations: int = 3, guess: Callable[[Density], Density] = lambda d: d * 0.5) -> Density[vdft.mul]:
...
@macro
def exp(argument: AnyDensity, terms: int = 4) -> Density[vdft.add]:
...
@macro
def ln(argument: AnyDensity, terms: int = 4) -> Density[vdft.add]:
...
@macro
def sin(argument: AnyDensity, terms: int = 3) -> Density[vdft.add]:
...
@macro
def cos(argument: AnyDensity, terms: int = 3) -> Density[vdft.add]:
...
@macro
def tan(argument: AnyDensity, terms: int = 3) -> Density[vdft.mul]:
...
@macro
def asin(argument: AnyDensity, terms: int = 3) -> Density[vdft.add]:
...
@macro
def acos(argument: AnyDensity, terms: int = 3) -> Density[vdft.add]:
...
@macro
def atan(argument: AnyDensity, terms: int = 3) -> Density[vdft.add]:
...
@macro
def sinh(argument: AnyDensity, terms: int = 3) -> Density[vdft.add]:
...
@macro
def cosh(argument: AnyDensity, terms: int = 3) -> Density[vdft.add]:

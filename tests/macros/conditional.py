...
def test_logic():
    ...
    assert (when("in1").equals(0) & when("in2").equals(1)).then(10).otherwise(-10) ==\
        range_choice("minecraft:in1", 0.0, EPS, range_choice("minecraft:in2", 1.0, 1.0 + EPS, 10.0, -10.0), -10.0)

    assert (when("in1").equals(0) | when("in2").equals(1)).then(10).otherwise(-10) ==\
        range_choice("minecraft:in1", 0.0, EPS, 10.0, range_choice("minecraft:in2", 1.0, 1.0 + EPS, 10.0, -10.0))
